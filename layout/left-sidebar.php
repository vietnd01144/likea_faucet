    ...
    <div class="sidebar">
            ...
            <ul>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        ...
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Home</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/game-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Game</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/coin-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Earn Coins</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/rev-share-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Rev share</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/the-vault.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">The vault</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/vip-club-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Vip club</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/refferal-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">Referrals</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <img src="../media/image/new-icon.svg">
                        <p class="text-menu-sidebar fs-16 lh-22 fw-800">News</p>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <div class="advertising-page">
            <a href="#" class="button-advertising-page">
                ...
                <span class="text-advertising-page fw-800 fs-15 lh -20">Advertising page</span>
            </a>
        </div>
        <div class="join-our-community">
        </div>
        <div class="invite-your-friend">
            <span class="title-side-invite text-primary-1 fw-800 fs-12 lh-16">Invite your Friends</span>
            <span class="content-side-invite fw-400 fs-15 lh-20">
        ...
        <div class="faq-side">
            <span class="title-faq-side text-primary-1 fw-800 fs-12 lh-16">FAQ</span>
            <ul>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="text-menu-sidebar fs-15 lh-20 fw-500">Documentation</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        ...
                        <p class="text-menu-sidebar fs-15 lh-20 fw-500">Provably fair</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        ...
                        <p class="text-menu-sidebar fs-15 lh-20 fw-500">Payment proof</p>
                    </a>
                </li>
                <li class="nav-item has-treeview">
                    <a class="d-flex nav-link nav-link-icon align-items-center">
                        ...
                        <p class="text-menu-sidebar fs-15 lh-20 fw-500">Contact support</p>
                    </a>
                </li>
            </ul>
        </div>
